'use strict';
angular.module('app')
.controller('BCRcvDetailCtrl', ['$rootScope', '$scope', 'ItemData', '$uibModalInstance', 'Dialog', 'toastr', 'AjaxService', 'Form',
function ($rootScope, $scope, ItemData, $uibModalInstance, Dialog, toastr, AjaxService, Form) {
    ...
    function SaveEdit(index) {
        ...
        vm.promise = AjaxService.PlanUpdate("BCRcvDetail", en).then(function (data) {
            toastr.success('更新成功');
            GetDetail();
        });
    }
    ...
    function ScanCode(isForce) {
        ...
        vm.promise = AjaxService.ExecPlan("BCRcvDetail", "Scan", en).then(function (data) {
            console.log(data);
    ...
    //明细
    function GetDetail() {
        vm.promise = AjaxService.GetPlansPage("BCRcvDetail", GetCondition(), vm.page.pageIndex, vm.page.pageSize).then(function (data) {
            vm.SNList = data.List;
    ...
    function ClearBSN(sncode) {
        ...
        en.RcvID = vm.Item.ID;
        vm.promise = AjaxService.ExecPlan('BCRcvDetail', 'Delete', en).then(function (data) {
