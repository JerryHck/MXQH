'use strict';
angular.module('app')
.controller('RDShipDetailCtrl', ['$rootScope', '$scope', 'ItemData', '$uibModalInstance', 'Dialog', 'toastr', 'AjaxService', 'Form',
function ($rootScope, $scope, ItemData, $uibModalInstance, Dialog, toastr, AjaxService, Form) {
    ...
    function SaveEdit(index) {
        ...
        vm.promise = AjaxService.PlanUpdate("RDShipDetail", en).then(function (data) {
            toastr.success('更新成功');
            GetDetail();
        });
    }
    ...
    function ScanCode(isForce) {
        ...
        vm.promise = AjaxService.ExecPlan("RDShipDetail", "Scan", en).then(function (data) {
            console.log(data);
    ...
    function ClearBSN(sncode) {
        ...
        en.ShipID = vm.Item.ID;
        vm.promise = AjaxService.ExecPlan('RDShipDetail', 'Delete', en).then(function (data) {
