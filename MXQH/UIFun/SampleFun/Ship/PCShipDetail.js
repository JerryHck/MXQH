'use strict';
angular.module('app')
.controller('PCShipDetailCtrl', ['$rootScope', '$scope', 'ItemData', '$uibModalInstance', 'Dialog', 'toastr', 'AjaxService', 'Form',
function ($rootScope, $scope, ItemData, $uibModalInstance, Dialog, toastr, AjaxService, Form) {
    ...
    function SaveEdit(index) {
        ...
        vm.promise = AjaxService.PlanUpdate("PCShipDetail", en).then(function (data) {
            toastr.success('更新成功');
            GetDetail();
        });
    }
    ...
    function ScanCode(isForce) {
        ...
        console.log(en);
        vm.promise = AjaxService.ExecPlan("PCShipDetail", "Scan", en).then(function (data) {
    ...
    //明细
    function GetDetail() {
        vm.promise = AjaxService.GetPlansPage("PCShipDetail", GetCondition(), vm.page.pageIndex, vm.page.pageSize).then(function (data) {
            vm.SNList = data.List;
    ...
    function ClearBSN(sncode) {
        ...
        en.ShipID = vm.Item.ID;
        vm.promise = AjaxService.ExecPlan('PCShipDetail', 'Delete', en).then(function (data) {
