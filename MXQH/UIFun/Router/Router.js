...
angular.module('app')
.controller('MesRouterCtrl', ['$rootScope', '$scope', '$window', 'Dialog', 'toastr', 'AjaxService', 'MyPop', '$ocLazyLoad',
function ($rootScope, $scope, $window, Dialog, toastr, AjaxService, MyPop, $ocLazyLoad) {
