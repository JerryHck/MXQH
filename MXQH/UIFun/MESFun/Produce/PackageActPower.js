...
angular.module('app')
.controller('PackageActPowerCtrl', ['$rootScope', '$scope', 'MyPop', 'AjaxService', 'toastr', '$window',
function ($rootScope, $scope, MyPop, AjaxService, toastr, $window) {
    ...
    function KeyDonwSnCode(e) {
        ...
        if (keycode == 13 && vm.Item.SNCode) {
            ...
            AjaxService.ExecPlan("MESPackageDtl", 'checkGFSn', en).then(function (data) {
            ...
            AjaxService.ExecPlan("MESPackageMain", "GetItem", { WorkOrder: vm.Item.WorkOrder }).then(function (data) {
                if (data.data[0].MsgType == '0') {
                    ...
                    if (data.data1.length==0) {
                        ...
                        vm.ItemData = data.data1[0];
                        vm.PackMain = data.data1[0];
                        vm.Item.SNCode = undefined;
