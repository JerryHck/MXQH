'use strict';
angular.module('app')
.controller('AucWPOAteSerCtrl', ['$rootScope', '$scope', '$http', 'AjaxService', 'toastr', '$window',
function ($rootScope, $scope, $http, AjaxService, toastr, $window) {
    ...
    function PageChange() {
        ...
        vm.promise = AjaxService.ExecPlan("MESWPOAte", "ate", vm.Ser).then(function (data) {
    ...
    function ExportExcel() {
        ...
        vm.Ser.StartDate = vm.Ser.StartDate == '' ? undefined : vm.Ser.StartDate;
        vm.Ser.EndDate = vm.Ser.EndDate == '' ? undefined : vm.Ser.EndDate;
        vm.promise = AjaxService.GetPlanExcel("MESWPOAte", "ate", vm.Ser).then(function (data) {
            //console.log(data);
