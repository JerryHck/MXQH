		...
		compile: function(element, attrs) {
			...
			return function postLink(scope, iElement, iAttrs, ngModel) {
				...
				ngModel.$parsers.push(function (viewValue) {
				    model = viewValue;
				    if (angular.isUndefined(attrs.onValue) && angular.isUndefined(attrs.offValue)) {
				        return viewValue;
				    }
				    else {
				        return !!viewValue ? attrs.onValue : attrs.offValue;
				    }
				});
				...
				ngModel.$render = function () {
				    ...
				    else if (ngModel.$viewValue == attrs.onValue) {
				        scope.model = true;
				    }
				    else if (ngModel.$viewValue == attrs.offValue) {
				        scope.model = false;
				    }
				};
