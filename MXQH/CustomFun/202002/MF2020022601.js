...
function ($rootScope, $scope, $http, AjaxService, toastr, $window) {
    ...
    function SaveInsert() {
        vm.promise = AjaxService.PlanInsert("EntityCache", vm.NewItem).then(function (data) {
            PageChange();
            toastr.success('新增成功');
            vm.IsInsert = false;
        });
    ...
    function Delete(item) {
        ...
        vm.promise = AjaxService.PlanDelete("EntityCache", en).then(function (data) {
            PageChange();
            toastr.success('删除成功');
        });
    }
    ...
    function PageChange() {
        vm.promise = AjaxService.GetPlansPage("EntityCache", GetContition(), vm.page.index, vm.page.size).then(function (data) {
            vm.List = data.List;
    ...
    function ExportExcel() {
        vm.promise = AjaxService.GetPlanOwnExcel("EntityCache", GetContition()).then(function (data) {
