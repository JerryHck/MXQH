...
angular.module('app')
.controller('ctrl-baqhh', ['$rootScope', 'Dialog', '$scope', '$http', 'AjaxService', 'toastr', '$window', '$filter',
function ($rootScope, Dialog, $scope, $http, AjaxService, toastr, $window, $filter) {
    ...
    function Open(item) {
        Dialog.OpenDialog("qlBadDialogHH", item).then(function (data) {
            PageChange();
    ...
    function PageChange() {
        vm.promise = AjaxService.GetPlansPage("MESvw_qlBadAcquisitionHH", GetContition(), vm.page.index, vm.page.size).then(function (data) {
            vm.List = data.List;
    ...
    function PageChange2() {
        vm.promise = AjaxService.GetPlansPage("MESvw_qlBadAcquisitionHH", GetContition2(), vm.page2.index, vm.page2.size).then(function (data) {
            vm.List2 = data.List;
    ...
    function ExportExcel() {
        vm.promise = AjaxService.GetPlanOwnExcel("MESvw_qlBadAcquisitionHH", GetContition2()).then(function (data) {
