...
angular.module('app')
.controller('baCustom', ['$rootScope', '$scope', '$http', 'AjaxService', 'toastr', '$window',
function ($rootScope, $scope, $http, AjaxService, toastr, $window) {
    ...
    function SaveInsert() {
        vm.promise = AjaxService.PlanInsert("baCustom", vm.NewItem).then(function (data) {
            PageChange();
            toastr.success('新增成功');
            vm.IsInsert = false;
        });
    ...
    function Delete(item) {
        ...
        vm.promise = AjaxService.PlanDelete("baCustom", en).then(function (data) {
            PageChange();
            toastr.success('删除成功');
        });
    }
    ...
    function SaveEdit(index) {
        ...
        vm.promise = AjaxService.PlanUpdate("baCustom", en).then(function (data) {
            PageChange();
            toastr.success('更新成功');
        });
    }
    ...
    function ExportExcel() {
        vm.promise = AjaxService.GetPlanOwnExcel("baCustom", GetContition()).then(function (data) {
