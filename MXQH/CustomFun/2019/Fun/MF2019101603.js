...
angular.module('app')
.controller('qlBadHHctrl', ['$rootScope', '$scope', '$http', 'AjaxService', 'toastr', '$window', '$filter',
function ($rootScope, $scope, $http, AjaxService, toastr, $window, $filter) {
    ...
    function SaveInsert() {
        vm.promise = AjaxService.PlanInsert("qlbadHH", vm.NewItem).then(function (data) {
            PageChange();
            toastr.success('新增成功');
            vm.IsInsert = false;
        });
    ...
    function Delete(item) {
        ...
        vm.promise = AjaxService.PlanDelete("qlbadHH", en).then(function (data) {
            PageChange();
            toastr.success('删除成功');
        });
    }
    ...
    function SaveEdit(index) {
        ...
        vm.promise = AjaxService.PlanUpdate("qlbadHH", en).then(function (data) {
            PageChange();
            toastr.success('更新成功');
        });
    }
    ...
    function PageChange() {
        vm.promise = AjaxService.GetPlansPage("qlbadHH", GetContition(), vm.page.index, vm.page.size).then(function (data) {
            vm.List = data.List;
    ...
    function ExportExcel() {
        vm.promise = AjaxService.GetPlanOwnExcel("qlbadHH", GetContition()).then(function (data) {
