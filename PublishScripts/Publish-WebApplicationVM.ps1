...
#>
[CmdletBinding(HelpUri = 'https://go.microsoft.com/fwlink/?LinkID=391696')]
param
(
...
function New-WebDeployPackage
{
    ...
    #若要生成 Web 应用程序，请使用 MsBuild.exe。若要寻求帮助，请参阅 http://go.microsoft.com/fwlink/?LinkId=391339 上的 MSBuild 命令行参考
}
...
function Test-WebApplication
{
    ...
    #若要编写一个函数以对 Web 应用程序运行单元测试，请使用 VSTest.Console.exe。若要寻求帮助，请参阅 http://go.microsoft.com/fwlink/?LinkId=391340 上的 VSTest.Console 命令行参考
}
...
try
{
    ...
    {
         throw '无法加载 Azure PowerShell。若要安装最新版本，请转到 http://go.microsoft.com/fwlink/?LinkID=320552。如果你已安装 Azure PowerShell，则可能需要重新启动计算机或手动导入该模块。'
    }
